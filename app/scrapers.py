...
HTTP_SEMAPHORE = asyncio.Semaphore(6)        # Max 6 parallel HTTP API calls
PLAYWRIGHT_SEMAPHORE = asyncio.Semaphore(3)  # Max 3 parallel Chromium worker contexts
...
def validate_match(match: Dict[str, Any]) -> bool:
    """Strict validation to prevent false-positive matches from entering the pipeline."""
...
BOOKMAKER_REGISTRY = {
    ...
    "1xbet": {"platform": "playwright_spa", "url": "https://1xbet.co.tz/en/line/football", "keywords": ["get1x2", "compresszip", "getclubslinezip", "linefeed", "sports"], "parser": "1xcorp"},
